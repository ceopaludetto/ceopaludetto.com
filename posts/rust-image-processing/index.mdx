...
cover: 
  ...
  alt: "Rusty car panel"
  url: "https://unsplash.com/photos/a-close-up-of-a-car-steering-wheel-JvvMFFGl6FY"
draft: false
---
...
<FileTree
	tree={[
		{	
			name: ".cargo", 
			children: [
				{ name: "config.toml", comment: "cargo configuration file" }
			]
		},
		{
			name: "src",
			children: [
				{ name: "lib.rs", comment: "rust source code file" }
			]
		},
		{ name: "Cargo.toml", comment: "cargo configuration file" },
		{ name: "build.rs", comment: "build script for rust" },
		{ name: "package.json", comment: "NPM package configuration file" },
	]}
/>
